...
void SkCanvas::drawVertices(const sk_sp<SkVertices>& vertices, SkBlendMode mode,
                            const SkPaint& paint) {
    TRACE_EVENT0("skia", TRACE_FUNC);
    cout << "SkCanvas::drawVertices" << endl;
...
void SkCanvas::onDrawRect(const SkRect& r, const SkPaint& paint) {
    cout << "SkCanvas::onDrawRect" << endl;

    ofstream file;
    file.open("commands.log", std::ios_base::app);
    string command =
      "skPaint = new CanvasKit.SkPaint();"
      "skPaint.setColor(CanvasKit.Color(" + to_string(paint.getColor()) + "));"
      "skCanvas.drawRect(CanvasKit.LTRBRect("
      + to_string(r.left()) + ","
      + to_string(r.top()) + ","
      + to_string(r.right()) + ","
      + to_string(r.bottom()) + "), skPaint);\n";
    file << command;
...
void SkCanvas::drawSimpleText(const void* text, size_t byteLength, SkTextEncoding encoding,
    ...
    cout << "SkCanvas::drawSimpleText" << endl;
    cout << text << endl;
...
void SkCanvas::drawTextBlob(const SkTextBlob* blob, SkScalar x, SkScalar y,
                            const SkPaint& paint) {
    TRACE_EVENT0("skia", TRACE_FUNC);
    cout << "SkCanvas::drawTextBlob" << endl;
    /* cout << blob.bounds() */
    /* blob.get */
    /* ofstream file; */
    /* file.open("commands.log", std::ios_base::app); */
    /* string command = */
    /*   "skFont = new CanvasKit.SkFont(null)" */
    /*   "skPaint = new CanvasKit.SkPaint()" */
    /*   "skPaint.setStyle(CanvasKit.PaintStyle.Fill)" */
    /*   "skPaint.setAntiAlias(true)" */
    /*   "skCanvas.drawText('" + blob.?? "')"; */
...
void SkCanvas::onDrawVerticesObject(const SkVertices* vertices, const SkVertices::Bone bones[],
    ...
    cout << "SkCanvas::onDrawVerticesObject" << endl;
...
void SkCanvas::onDrawPatch(const SkPoint cubics[12], const SkColor colors[4],
    ...
    cout << "SkCanvas::onDrawPatch" << endl;
